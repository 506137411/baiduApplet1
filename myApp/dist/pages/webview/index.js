...
var Webview = (_temp2 = _class = function (_BaseComponent) {
  ...
  function Webview() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Webview.__proto__ || Object.getPrototypeOf(Webview)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["url"], _this.config = {
  ...
  _createClass(Webview, [{
    ...
    value: function componentDidMount() {
      var url = this.$router.params.url;
...
Page(require('../../npm/@tarojs/taro-swan/index.js').default.createComponent(Webview, true));